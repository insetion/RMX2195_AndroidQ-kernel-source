...
err:
	...
	destroy_workqueue(mdwc->dwc3_wq);
#ifdef VENDOR_EDIT
/* shanliangliang@BSP.CHG.Basic, 2020/03/23, update for which may lead cash when driver defer if it's not release */
	oppodwc = NULL;
#endif
	return ret;
}
...
/*Zhiguo.Yu@ODM.BSP.System, 2020/06/28, modify for usb-performance*/
#ifdef ODM_HQ_EDIT
...
#ifdef VENDOR_EDIT
	/* LiYue@BSP.CHG.Basic, 2020/05/12, Add for charging */
