...
#ifdef VENDOR_EDIT
/*Bin.Xu@BSP.Kernel.Statbily, 2020/05/07, checklist: fs sync when suspending to speed up*/
/**
...
#ifndef VENDOR_EDIT
/*Bin.Xu@BSP.Kernel.Statbily, 2020/05/07, checklist: fs sync when suspending */
	trace_suspend_resume(TPS("sync_filesystems"), 0, true);
